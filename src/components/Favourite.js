                            ...
                            <ul class="list-group favourites-genres">
                                {
                                    this.state.genres.map((genre)=>(
                                        ...
                                        style={{
                                            backgroundImage: 
                                            "linear-gradient(to right, purple, white)",color:'white',fontWeight:'bold'}}>
                                            {genre}
                                        </li> :
                                        <li class="list-group-item" 
                                        style={{
                            ...
                            <div className="col-lg-9 favourites-table col-sm-12">
                                ...
                                <div className="row">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th classname="th1" scope="col" style={{color:'white',width:'55%'}}><center>Ttile</center></th>
                                                <th classname="th2" scope="col" style={{color:'white',width:'11%'}}><center>Genre</center></th>
                                                <th classname="th3" scope="col" style={{
                                                    color:'white',
                                                    width:'15%'}}><center>
                                                        <i class="fas fa-sort-up" onClick={this.sortPopularityDesc}></i>
                                                            Popularity
                                                        <i class="fas fa-sort-down" onClick={this.sortPopularityAsc}></i>
                                                </center></th>
                                                <th classname="th4" scope="col" style={{
                                                    color:'white',
                                                    width:'11%'}}><center>
                                                        <i class="fas fa-sort-up" onClick={this.sortRatingDesc}></i>
                                                            Rating
                                                        <i class="fas fa-sort-down" onClick={this.sortRatingAsc}></i>
                                                </center></th>
                                                <th classname="th4" scope="col" style={{color:'white',width:'5%'}}></th>
                                            </tr>
                                        </thead>
                                        <tbody>  
                                            {
                                                filterarr.map((movieObj)=>(
                                                    <tr>
                                                        <td style={{color:'white'}}>
                                                            ...
                                                            alt={movieObj.title} style={{width:'5rem'}}/> 
                                                        ...
                                                        <td>
                                                            ...
                                                            style={{backgroundImage: "linear-gradient(to right, white, red, white)"}}>
                                                                    Delete
                                                            </button>
                                                        </td>
                                                    </tr>
